...
- [Electrical Control Workshop](#electrical-control-workshop)
  ...
  - [电机](#电机)
    - [什么是电机](#什么是电机)
      ...
      - [舵机](#舵机)
      - [有刷/无刷电机](#有刷无刷电机)
    - [如果去控制一个电机 ~~这才是重点~~](#如果去控制一个电机-这才是重点)
...
1. GPIO引脚
   ...
   1. 推挽模式
   <img decoding="async" src="./img/推挽.jpg" width = "400">
   <img decoding="async" src="./img/推挽2.jpg" width = "400">

   2. 开漏模式
   <img decoding="async" src="./img/开漏.jpg" width = "400">

   3. 比较和注意事项
   上拉电阻
   <img decoding="async" src="./img/推挽开漏比较.jpg" width = "400">
...
<img decoding="async" src="./img/步进电机.png" width="50%">
...
以官方提供的不知名有刷电机为例
<img decoding="async" src="./img/tt电机.png" width="50%">

电机只有电源输入，将他直接连上电源已经开关，就打成了一个只有两种状态01的电机。 ~~但显然这无法满足任何的需求~~

为了更好的控制电机输入(转速/位置etc.) 我们需要控制电机的输入。
...
<img decoding="async" src="./img/占空比.webp" width="50%">
...
<img decoding="async" src="./img/L298N_3.png" width="100%">
...
<img decoding="async" src="./img/整体接线.jpg" width="40%">

<img decoding="async" src="./img/ps2线.jpg" width="40%">
